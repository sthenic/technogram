#let describe(label, note: none, indent: 30pt, body) = {
  context if target() == "html" {
    html.div(class: "tg-describe")[
      #html.div(class: "tg-describe-header")[
        #html.span(class: "tg-describe-label")[#label]
        #if note != none { html.span(class: "tg-describe-note")[#note] }
      ]
      #html.div(class: "tg-describe-body", style: "margin-left: " + repr(indent))[#body]
    ]
  } else {
